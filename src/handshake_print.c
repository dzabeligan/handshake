...
void logTerminals(TAMSResponse* tamsResponse) {
  ...
  debug("PAYSHARP:                      %s", tamsResponse->terminals.paySharp);
  debug("VERIFONE:                      %s", tamsResponse->terminals.verifone);
}
...
void logServers(TAMSResponse* tamsResponse) {
  debug(
      "Middleware server type:        %s",
      middlewareServerTypeToString(tamsResponse->servers.middlewareServerType));
  ...
  debug("Remote Upgrade Private IP:     %s",
        tamsResponse->servers.remoteUpgrade.publicServer.ip);
  debug("Call Home Public IP:           %s", tamsResponse->servers.callhome.ip);
...
void logTamsResponse(TAMSResponse* tamsResponse) {
  ...
  debug("Stamp Duty Threshold:          %s", tamsResponse->stampDutyThreshold);
  debug("Stamp Label:                   %s", tamsResponse->stampLabel);
  debug("Terminal App Type:             (%d) %s", tamsResponse->terminalAppType,
